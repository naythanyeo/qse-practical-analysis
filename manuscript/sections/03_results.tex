...
These variations indicate that the magnitude of the representability error is not determined by state character alone. 
We therefore examine several representative molecular cases to identify the electronic-structure features associated with these deviations.
