...
% Explaining singlet trends 
% Discussion on the fact that ansatz contains doubles, but wrong percentage 

% Case studies 

% CS1: 2 double bond molecules 

% CS2: delayed active space errors, eg benzene 

% CS3: imidazole, generally with no double bonds molecules 
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/keynote_figures/case_study_imidazole_benzene.pdf}
    \caption{Active-space dependence of the representative Benzene and Imidazole case studies.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/dimension_analysis/overlap_eigenvalue_spread/uccsd_6e6o.pdf}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/dimension_analysis/overlap_eigenvector_composition/uccsd_6e6o.pdf}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/shots/best_threshold_heatmap.pdf}
