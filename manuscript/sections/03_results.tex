...
\begin{figure}[htbp]
    ...
    \includegraphics[
        width=\linewidth
    ]{figures/active_space_representability/uccsd_tiered_error_ridgelines.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/dimension_analysis/overlap_eigenvalue_spread/uccsd_6e6o.png}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/dimension_analysis/overlap_eigenvector_composition/uccsd_6e6o.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/ov_doubles_s1_error_comparison.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/matrix_heatmaps/uccsd_6e6o_shot_overlap.png}
