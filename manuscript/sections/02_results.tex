...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/projection_error/projection_error_6e6o_UCCSD.png}
...
\end{figure}
Beyond errors pertaining to outliers, we further look at the geometric representability of QSE states to better qualify the errors. We define a quantity called the projection 
