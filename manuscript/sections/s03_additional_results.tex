...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/active_space_representability/uccsd_error_vs_projection_deficit.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/active_space_representability/casci_doubles_weight/low_state_double_excitation_weight_scaling.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/active_space_representability/uccsd_q1_best_root_transition_map.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/dimension_analysis/overlap_eigenvalue_spread/1upccgsdsinglet_triplet_6e6o.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/commuting_group_scaling.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/matrix_heatmaps/uccsd_h_s_element_regression.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/breaking_hs_correlated_errors.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/matrix_heatmaps/uccsd_6e6o_singlet_overlap.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/scaling_future_work/matrix_heatmaps/uccsd_6e6o_triplet_overlap.png}
