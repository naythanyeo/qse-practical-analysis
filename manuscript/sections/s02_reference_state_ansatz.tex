...
We then present the spin diagnostics and supplementary spin-purity results obtained for the different reference ansätze.
...
\label{sec:si-spin-operators}
To evaluate the spin expectation values 
